...
import imgui.moulberry90.extension.texteditor.flag.TextEditorColor;
import imgui.moulberry90.extension.texteditor.flag.TextEditorScroll;
...
public final class TextEditor extends ImGuiStructDestroyable {
    ...
    */
    ...
    public TextEditorCursorPosition getMainCursorPosition() {
        return nGetMainCursorPosition();
    }

    private native TextEditorCursorPosition nGetMainCursorPosition(); /*
        return (uintptr_t)THIS->GetMainCursorPosition();
    */

    public TextEditorCursorPosition getCurrentCursorPosition() {
        return nGetCurrentCursorPosition();
    }

    private native TextEditorCursorPosition nGetCurrentCursorPosition(); /*
        return (uintptr_t)THIS->GetCurrentCursorPosition();
    */

    public TextEditorCursorPosition getCursorPosition(final long cursor) {
        return nGetCursorPosition(cursor);
    }

    private native TextEditorCursorPosition nGetCursorPosition(long cursor); /*
        return (uintptr_t)THIS->GetCursorPosition(cursor);
    */

    public TextEditorCursorSelection getCursorSelection(final long cursor) {
        return nGetCursorSelection(cursor);
    }

    private native TextEditorCursorSelection nGetCursorSelection(long cursor); /*
        return (uintptr_t)THIS->GetCursorSelection(cursor);
    */

    public TextEditorCursorSelection getMainCursorSelection() {
        return nGetMainCursorSelection();
    }

    private native TextEditorCursorSelection nGetMainCursorSelection(); /*
        return (uintptr_t)THIS->GetMainCursorSelection();
    */
